            ...
            <div style="padding: 6rem 0rem;">
                ...
                <div class="row  flex-column-reverse flex-lg-row">
                    ...
                    <div class="col-lg-6 text-center">
                        <img src="update-image/seo-banner.jpg" height="auto" width="80%" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container  ">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 text-center my-5 digital_marketing">
                        <div class="service_cards pb-5 bg-white rounded h-100  text-center">
                            <div class="bg-   p-3 mb-4">
                                <img src="update-image/service/card1.jpg" height="auto" style="object-fit: cover;" width="80%"
                                    alt="SEO image">
                            </div>
                            <div class="pb-4 px-2 ">
                                <h4>Local SEO</h4>
                    ...
                    <div class="col-md-6 col-lg-4 text-center my-5 digital_marketing">
                        <div class="service_cards pb-5 bg-white rounded h-100  text-center">
                            <div class="bg-   p-3 mb-4">
                                <img src="update-image/service/card2.jpg" height="auto" style="object-fit: cover;" width="80%"
                                    alt="SEO image">
                            </div>
                            <div class="pb-4 px-2 ">
                    ...
                    <div class="col-md-6 col-lg-4 text-center my-5 digital_marketing">
                        <div class="service_cards pb-5 bg-white rounded h-100  text-center">
                            <div class="bg-   p-3 mb-4">
                                <img src="update-image/service/card3.jpg" height="auto" style="object-fit: cover;" width="80%"
                                    alt="SEO image">
                            </div>
                            <div class="pb-4 px-2 ">
                                <h4>Ecommerce SEO</h4>
